...
function GeneralDashboard() {
  ...
  const getRoleDisplay = (role) => {
    switch (role) {
      case "VENDEDOR":
        return { text: "Vendedor", icon: <ShopOutlined />, color: "#1890ff" };
      case "COMPRADOR":
        return {
          text: "Comprador",
      ...
      default:
        return { text: "Usuario", icon: <UserOutlined />, color: "#666" };
    }
  };
              ...
              >
                <div style={{ textAlign: "center", padding: "20px" }}>
                  ...
                  <Text type="secondary">
                    ...
                    {user?.role === "COMPRADOR" &&
                      "Puedes comprar y ver productos"}
                    {user?.role === "ADMIN" &&
                      "Tienes acceso completo al sistema"}
                    {!user?.role &&
                      "Rol no especificado - Contacta al administrador"}
                  </Text>
                </div>
              </Card>
            </Col>
